                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td class="td-actions text-right">
                                        ...
                                        <a href="{{ route('product.edit', $invoice) }}" class="btn btn-success btn-simple btn-sm">
                                            <i class="ti-pencil-alt"></i> Edit
                                        </a>
                                        <a href="{{ route('product.destroy', $invoice) }}" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-simple btn-sm">
